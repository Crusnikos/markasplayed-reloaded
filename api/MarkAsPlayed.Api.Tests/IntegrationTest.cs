...
public class IntegrationTest : WebApplicationFactory<Program>, IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        client.DefaultRequestHeaders.Authorization =
            new AuthenticationHeaderValue(TestAuthentication.DefaultScheme, "token");
    ...
    {
        services.AddAuthentication(TestAuthentication.DefaultScheme)
                .AddScheme<AuthenticationSchemeOptions, TestAuthentication>
                (
                    TestAuthentication.DefaultScheme, _ => { }
                );
    }
